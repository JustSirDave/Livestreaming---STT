...
VAD_FLUSH_FRAMES = 15        # frames — consecutive silent frames before flushing segment to ASR (~480ms at 32ms/frame)
...
INTERIM_INTERVAL_FRAMES = 47 # frames — fire interim ASR every ~1.5s during speech (47 × 32ms ≈ 1.5s)
