...
VAD_FLUSH_FRAMES = 6         # frames — consecutive silent frames before flushing segment to ASR (~192ms at 32ms/frame)
...
INTERIM_INTERVAL_SEC = 0.5   # seconds — how often the interim worker re-transcribes during speech
INTERIM_TAIL_FRAMES = 125    # frames — only feed the last ~4s of audio to interim (better context for longer utterances)
